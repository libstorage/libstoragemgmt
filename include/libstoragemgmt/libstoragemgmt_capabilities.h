...
typedef enum {
    ...
    LSM_CAP_SNAPSHOTS                               = 106,
    LSM_CAP_SNAPSHOT_CREATE                         = 107,
    LSM_CAP_SNAPSHOT_CREATE_SPECIFIC_FILES          = 108,
    LSM_CAP_SNAPSHOT_DELETE                         = 109,
    LSM_CAP_SNAPSHOT_REVERT                         = 110,
    LSM_CAP_SNAPSHOT_REVERT_SPECIFIC_FILES          = 111,
